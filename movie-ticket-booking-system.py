...
root.title('MOVIE TICKET BOOKING SYSTEM') # Showing the title for the GUI 
...
class LoginScreen: # The Login screen
    ...
    def createView(self, master):
        Label(master,text='MOVIE TICKET BOOKING SYSTEM',font="Arial 30 bold italic",bd=5,bg="blue",relief='ridge').pack()
...
class BookTicketScreen:
    ...
    def createView(self, username): # This class is used to select movie
        ...
        self.wBookTicket.geometry('600x600')
    ...
    # Your Auth Token from twilio.com/console
        auth_token  = "1af1094660720cefb898926b4737755d"
